...
read -p " ${WARN} Do you want install optionally apps? (y:n)     " initial_choice 
...
read -p " ${WARN} Do you want install dwm(dont work now), hyprland or budgue? (d:w:b)    " dhb
